...
if (!dir.exists("temp/simulations/balanced")) dir.create("temp/simulations/balanced")
if (!dir.exists("temp/simulations/unbalanced")) dir.create("temp/simulations/unbalanced")
